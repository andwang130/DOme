...
def get_playapImch(price,ip,openid):
    ...
    data["sign"]=get_sign({"openid":data["openid"],"total_fee":data["total_fee"],"spbill_create_ip":data["spbill_create_ip"],"out_trade_no":data["out_trade_no"],"appid":data["appid"],"mch_id":data["mch_id"],"device_info":data["device_info"],"nonce_str":data["nonce_str"],"body":data["body"]})
    print(data)
