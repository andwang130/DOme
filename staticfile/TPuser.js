                    ...
                    if (arg["code"] == "0") {
                        ...
                        for(var i=0;i<data.length;i++)
                        {
                            ...
                            var tr=" <tr>\n" +
                                ...
                                "\t\t\t\t\t<td  class=\"text-left vertical-middle _ticket\"><span class=\"label label-primary _ticket_lable\">"+data[i]["votenum"]+"</span> <button onclick='add_votedate(this)'>+</button><span><input type='number' name='votenum' style='display: none'><span></td><!-- 移入移出事件  -->\n" +
